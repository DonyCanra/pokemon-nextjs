      ...
      <div className="container">
        <div className="d-flex">
          ...
          <a className="header-brand" href="index.html">
            ...
            <img src="/images/brand/logo.png" className="header-brand-img dark-logo" alt="Azea logo" />
            <img src="/images/brand/logo.png" className="header-brand-img mobile-logo" alt="Azea logo" />
            <img src="/images/brand/logo.png" className="header-brand-img darkmobile-logo" alt="Azea logo" />
          </a>
