                  ...
                  <div className="dropdown profile-dropdown d-flex">
                    ...
                    <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
                      <div className="text-center">
                        <div className="text-center user pb-0 font-weight-bold">Patrenna</div>
                        <span className="text-center user-semi-title">Web Designer</span>
                        <div className="dropdown-divider"></div>
                      </div>
                      <a className="dropdown-item d-flex" href="profile-1.html">
                      ...
                      <a className="dropdown-item d-flex" href="search.html">
                        <svg className="header-icon me-2" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                          <path d="M0 0h24v24H0V0z" fill="none" />
                      ...
                      <a className="dropdown-item d-flex" href="chat.html">
                        ...
                        <div className="fs-13">Messages</div>
                      </a>
